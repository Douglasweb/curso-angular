...
AfterContentChecked {
    ...
    private loadEntry() {
        ...
        if (this.currentAction == 'edit') {
            this
                .route
                .paramMap
                .pipe(switchMap(params => this.entryService.getBydId(+ params.get("id"))))
                .subscribe((entry) => {
                    this.entry = entry;
                    this
                        .entryForm
                        .patchValue(entry) // binds loaded entry data to entryForm
    ...
    private createEntry() {
        ...
        this
            .entryService
            .create(entry)
            .subscribe(entry => this.actionsForSuccess(entry), error => this.actionsForError(error))
    }
